...
const initialTagKeys = (props.member.tags || []).map(t => t.key);
    ...
    <AuthLayout>
        ...
        <template #page-content>
            <FluidContainerWithRow>
                <div class="col-12">
                    <Card :with-card-header="true" card-title="Edit Member">
                        <template #card-body>
                            <div>
                            ...
                            <form method="post" :action="`/members/${member.id}`" @submit.prevent="updateMember">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
